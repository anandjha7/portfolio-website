...
$(document).ready(function () {
  ...
  //welcome to anand switch animation in navbar
  // navHeight : '70.8px';
  ...
  tl1.to(".logo.anand", { y: 0, opacity: 1 }, "anim");
  ...
  const reactAnim = gsap.timeline({ repeat: -1, repeatDelay: 0.5 });
  reactAnim.from(".logo-react", { scale: 0, rotation: -360, duration: 2 });
  reactAnim.to(".logo-react", {
    scale: 0,
    rotation: -360,
    duration: 2,
    delay: 1,
